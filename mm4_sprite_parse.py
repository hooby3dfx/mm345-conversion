...
if __name__ == "__main__":
    ...
    # parse_sprite("mm3to4_out/WATER.OUT", "test/out_mm4_test09", mode="xeen")#water.vga    
    parse_sprite("mm3to4_out/SKY.SKY", "test/out_mm4_test10", mode="xeen")#day.vga
    # parse_sprite("mm3to4_out/CAVE.SKY", "test/out_mm4_test11", mode="xeen")#cav.sky
    # parse_sprite("mm3to4_out/NIGHT.SKY", "test/out_mm4_test12", mode="xeen")#night.vga

    # parse_sprite("test/05_troll.mon.ccx", "test/out_mm4_test05_inception", mode="xeen")#troll.mon
    # parse_sprite("test/10_day.vga.ccx", "test/out_mm4_test10_inception", mode="xeen")#troll.mon
